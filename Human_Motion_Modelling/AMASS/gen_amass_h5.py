...
expr_code = 'VXX_SVXX_TXX' 

msg = ''' Initial use of standard AMASS dataset preparation pipeline '''

amass_dir = './data'

# Modify your splits here for

amass_splits = ['HumanEva', 'MPI_HDM05', 'SFU', 'MPI_mosh', 'Transitions_mocap', 'SSM_synced',
                'CMU', 'MPI_Limits', 'TotalCapture', 'Eyes_Japan_Dataset', 'KIT', 'DFaust_67',
...
for dataset_name in amass_splits:
    ...
    for model in model_lists:
        ...
        for motion in motion_lists:
            ...
            joints = body.Jtr
            # We use only joints information for our tasks
