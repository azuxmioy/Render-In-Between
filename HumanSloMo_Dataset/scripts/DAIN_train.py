...
parser.add_argument('--frame_input_dir', type = str, default = '../HumanSlomo/train/frames', help='frame input directory')
parser.add_argument('--frame_output_dir', type = str, default = '../HumanSlomo/train/', help='frame output directory')
...
for subfolder in subfolderlist:
    ...
    for _ in range(n_runs):
        ...
        for i in range (len(framelist)-2 ):
            ...
            output_frame_file_path = os.path.join(output_dir, 'train-'+frame_name + "{:.06f}.png".format(value) )
...
os.system("rm -rf %s/*/frame*" % os.path.join(args.frame_output_dir,'DAIN') )
